...
/// "Visible differences predictor: an algorithm for the assessment of image fidelity." Human Vision, Visual Processing, and Digital Display III. Vol. 1666.
/// and used in eq. (7)
...
protected:
  ...
  {
    m_param = ParameterType(0.006, 90.66, 1.05, 4.53);
  }
};
